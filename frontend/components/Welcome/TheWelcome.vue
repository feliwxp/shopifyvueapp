    ...
    <div class="card">
      <div class="left-text">
        ...
        <p>
          ...
          <a href="https://shopify.dev/docs/apps/getting-started/existing" target="_blank">this shopify tutorial</a>
        </p>
        <p>
          This starter template is available on
          <a href="https://github.com/Mini-Sylar/shopify-app-vue-template" target="_blank">Github</a>
        </p>
      </div>
