...
export class Client implements AnyClient {
  ...
  */
  ...
  developmentApiRoot = "https://vueapp--development.gadget.app/";
  productionApiRoot = "https://vueapp.gadget.app/";
  applicationId = "50728";
